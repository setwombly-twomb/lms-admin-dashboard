...
const contentFlows: FlowItem[] = [
  ...
  { title: 'Create Content', icon: FileAddOutlined, path: '/courses' },
    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-6">
            ...
            {userFlows.map((flow) => {
              ...
              return (
                <button
                  ...
                  className="flex flex-col items-center gap-2.5 p-4 bg-white rounded-xl border border-gray-200 hover:border-blue-200 hover:shadow-md transition-all group text-center"
                >
                  ...
                  <span className="text-sm font-medium text-gray-700 group-hover:text-gray-900 leading-tight">{flow.title}</span>
                </button>
              );
            })}
          </div>
        ...
        <div className="rounded-xl border border-purple-100 bg-gradient-to-br from-purple-50/60 to-white p-5">
          <div className="flex items-center gap-2.5 mb-4">
            ...
            <h3 className="text-base font-semibold text-gray-900">Content Management</h3>
          </div>
          <div className="grid grid-cols-3 gap-3">
            {contentFlows.map((flow) => {
              ...
              return (
                <button
                  key={flow.title}
                  onClick={() => navigate(flow.path)}
                  className="flex flex-col items-center gap-2.5 p-4 bg-white rounded-xl border border-gray-200 hover:border-purple-200 hover:shadow-md transition-all group text-center"
                >
      ...
      <div className="bg-gradient-to-br from-emerald-50 to-white rounded-xl border border-emerald-100 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <button onClick={() => navigate('/users')} className="bg-gradient-to-br from-blue-50 to-white rounded-lg border border-blue-100 p-4 hover:shadow-lg transition-shadow text-left cursor-pointer">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-blue-700 mb-1">Total Users</p>
                <p className="text-3xl font-semibold text-gray-900">2,847</p>
                <p className="text-sm text-blue-600 font-medium mt-1">+127 this month</p>
              </div>
          ...
          <button onClick={() => navigate('/courses')} className="bg-gradient-to-br from-purple-50 to-white rounded-lg border border-purple-100 p-4 hover:shadow-lg transition-shadow text-left cursor-pointer">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-purple-700 mb-1">Active Content</p>
                <p className="text-3xl font-semibold text-gray-900">162</p>
                <p className="text-sm text-purple-600 font-medium mt-1">+8 this month</p>
              </div>
          ...
          <button onClick={() => navigate('/analytics/lessons')} className="bg-gradient-to-br from-amber-50 to-white rounded-lg border border-amber-100 p-4 hover:shadow-lg transition-shadow text-left cursor-pointer">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-amber-700 mb-1">Completion Rate</p>
                <p className="text-3xl font-semibold text-gray-900">78.4%</p>
                <p className="text-sm text-amber-600 font-medium mt-1">+2.3% this week</p>
              </div>
